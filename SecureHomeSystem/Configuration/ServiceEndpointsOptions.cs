...
/// <summary>
/// Aggregates the external endpoints that release presenters reference when demoing
/// the stack. Centralising the metadata ensures the worker, documentation, and
...
/// <summary>
/// Endpoint description for the Ollama service, including health probe metadata so
/// operators can run scripted checks during rehearsals.
/// </summary>
...
/// <summary>
/// Configuration for the OpenWebUI front-end surfaced in release demos.
/// </summary>
...
/// <summary>
/// Metadata for the Stable Diffusion profile, capturing URLs and demo prompts used
/// in smoke tests.
/// </summary>

...
/// <summary>
/// Configuration block that captures how the worker interacts with Docker and
/// Compose. Each property mirrors a decision that operators narrate during
/// release-day walkthroughs (compose file location, label selectors, retry windows).
/// </summary>
...
/// <summary>
/// Nested detection settings that translate Docker labels into logical service
/// identifiers. Keeping the mapping declarative lets runbooks and tests explain
/// exactly why a container appears in logs.
/// </summary>
